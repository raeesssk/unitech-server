...
router.post('/add', oauth.authorise(), (req, res, next) => {
  ...
  pool.connect(function(err, client, done){
    ...
    client.query('BEGIN;');
      ...
      client.query('INSERT INTO expense_master(em_payment_mode, em_received_by, em_comment, em_date, em_cm_id, em_credit, em_payment_against, em_cheque_no, em_cheque_date, em_amount, em_status) values($1,$2,$3,$4,$5,$6,$7,$8,$9,0,0)',[expenseSingleData.em_payment_mode,expenseSingleData.em_received_by,expenseSingleData.em_comment,expenseSingleData.em_date,expenseSingleData.expensess.cm_id,expenseSingleData.em_amount,expenseSingleData.em_payment_against,expenseSingleData.em_cheque_no,expenseSingleData.em_cheque_date]);
