...
router.post('/', oauth.authorise(), (req, res, next) => {
    ...
    cmd.get('C:/"Program Files"/PostgreSQL/9.6/bin/pg_dump.exe --dbname=postgresql://postgres:zeartech@localhost:5432/mastersofa > ../backup/'+filename+'.sql --role postgres --format=c --blobs --encoding SQL_ASCII',
    function(err, data, stderr){
        if (!err) {
	        ...
	        let mailOptions = {
	            ...
	            subject: 'backup database file of Master Sofa', // Subject line
